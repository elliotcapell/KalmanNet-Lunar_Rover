...
class KalmanNetNN(torch.nn.Module):
    ...
    ### Initialize Sequence ###
    ###########################
    def InitSequence(self, M1_0, T, batch_indexes, t):
        """
        ...
        self.y_previous = self.h(self.m1x_posterior, batch_indexes, t)
    ...
    def step_prior(self, batch_indexes, t):
        ...
        self.m1y = self.h(self.m1x_prior, batch_indexes, t)
    ...
    def step_KGain_est(self, y):
        ...
        print(torch.sum(self.KGain[0]))
    #######################
    ### Kalman Net Step ###
    #######################
    def KNet_step(self, y, batch_indexes, t):

        # Compute Priors
        self.step_prior(batch_indexes, t)
    ...
    ### Forward ###
    ###############
    def forward(self, y, batch_indexes, t):
        y = y.to(self.device)
        batch_indexes = batch_indexes.to(self.device)
        return self.KNet_step(y, batch_indexes, t)
